...
type CreateVmRequest struct {
	...
	// Customer/tenant identifier for billing and isolation
...
func (x *CreateVmRequest) GetEnvironmentId() string {
	if x != nil {
...
const file_proto_metal_vmprovisioner_v1_vmprovisioner_proto_rawDesc = "" +
	...
	"\fconsole_type\x18\x04 \x01(\tR\vconsoleType\"\xdc\x01\n" +
	"\x0fCreateVmRequest\x12\x13\n" +
	"\x05vm_id\x18\x01 \x01(\tR\x04vmId\x128\n" +
	"\x06config\x18\x02 \x01(\v2 .metal.vmprovisioner.v1.VmConfigR\x06config\x12\x1b\n" +
	"\ttenant_id\x18\x03 \x01(\tR\btenantId\x12\x1d\n" +
	"\n" +
	"project_id\x18\x04 \x01(\tR\tprojectId\x12%\n" +
	"\x0eenvironment_id\x18\x05 \x01(\tR\renvironmentId\x12\x17\n" +
